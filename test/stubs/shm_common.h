...
// Test stub for shm_common.h — replaces <sdbusplus/bus.hpp> with
// <sdbusplus/message/native_types.hpp> to get the required types without
// pulling in the log_convert overloads that conflict with lg2.

#pragma once
#include <boost/interprocess/containers/string.hpp>
#include <boost/interprocess/managed_shared_memory.hpp>
// Use native_types directly — avoids the log_convert ambiguity from bus.hpp
